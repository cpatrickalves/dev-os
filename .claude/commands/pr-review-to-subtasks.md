...
Na descrição, coloque todo o conteúdo de cada item do arquivo, incluindo sugestões de código se houver, não faça referência ao arquivo ($1) nem cite os agentes revisores.
