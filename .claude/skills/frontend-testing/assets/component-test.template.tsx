...
describe('ComponentName', () => {
  ...
  describe('Props', () => {
    it('should apply custom className', () => {
      // WHY: Components should merge custom classes
  ...
  // --------------------------------------------------------------------------
  // Accessibility (optional but recommended for enterprise users)
  // --------------------------------------------------------------------------
  // WHY: Enterprise customers may require accessibility compliance
