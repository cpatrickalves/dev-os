...
This skill enables Claude to generate high-quality, comprehensive frontend tests for projects following established conventions and best practices.

> Use Vitest mock/timer APIs (`vi.*`).
...
Look for these files in the project to understand the test setup:

- `vitest.config.ts` - Vitest configuration
- `vitest.setup.ts` - Test environment setup and global mocks
- Existing `*.spec.tsx` / `*.spec.ts` files - Follow established patterns in the codebase
